#Calculate the codon decoding rate of RiboSeq in 0,+1,-1 frames
...
if out == 2:
    ...
    sys.exit("Invalid value for the third argument (2=+1 frame 0=-1 frame 1=0 frame)")
...
with open(longest_reference, 'r') as file2:
    ...
    for line in file2:
        if line.startswith(">"):
            ...
            seq += line[30:-30]# remove the first 30 and last 30 bases
